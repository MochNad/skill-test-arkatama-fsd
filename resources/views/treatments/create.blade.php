    ...
    <div class="bg-white shadow-2xl rounded-2xl overflow-hidden border border-red-100">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Add New Treatment</h2>
                    <p class="text-red-100 text-sm mt-1">Create a new medical treatment or service</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('treatments.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <select name="type" id="type" required class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 bg-white shadow-sm">
                        ...
                        <option value="Vaksin" {{ old('type') == 'Vaksin' ? 'selected' : '' }}>💉 Vaksin</option>
                        <option value="Grooming" {{ old('type') == 'Grooming' ? 'selected' : '' }}>✂️ Grooming</option>
