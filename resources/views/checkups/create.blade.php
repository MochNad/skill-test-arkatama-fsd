    ...
    <div class="bg-white shadow-2xl rounded-2xl overflow-hidden border border-red-100">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Add New Checkup</h2>
                    <p class="text-red-100 text-sm mt-1">Record a new pet medical checkup</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('checkups.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="notes" id="notes" rows="5"
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 shadow-sm resize-none">{{ old('notes') }}</textarea>
                </div>
