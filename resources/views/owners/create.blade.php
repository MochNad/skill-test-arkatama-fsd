    ...
    <div class="bg-white shadow-2xl rounded-2xl overflow-hidden border border-red-100">
        <div class="bg-gradient-to-r from-red-600 to-red-700 px-8 py-6">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-2xl font-bold text-white">Add New Owner</h2>
                    <p class="text-red-100 text-sm mt-1">Register a new pet owner</p>
                </div>
            </div>
        </div>
            ...
            <form action="{{ route('owners.store') }}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="address" id="address" rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 shadow-sm resize-none">{{ old('address') }}</textarea>
                </div>
                ...
                <div class="flex items-center justify-end gap-3 pt-6 border-t border-gray-200">
                    ...
                    <button type="submit" class="inline-flex items-center px-8 py-3 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                        <i class="fas fa-save mr-2"></i>Save Owner
                    </button>
                </div>
            </form>
        </div>
